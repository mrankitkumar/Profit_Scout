...
@section('title', 'test')
<link rel="stylesheet" href="{{ url('css/editsubadmin.css') }}" />
@section('content')
        ...
        <div class="row">
            <div class="card mt-5 p-1">
                <div class="card-header p-2">
                    <h3>Edit Sub-Admin - <span></span></h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label>Role</label>
                                <select class="form-select smallwidth" aria-label="role" name="rolename" >
