...
<form id="editProfileForm" action="{{ url('/admin/editcompany') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-md-3 editcustomerpart">
            ...
            <input id="id"  style="display: none" name="companyid" value="{{$company->id}}">
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <span id="mobilenumber_error" class="form-text text-danger"></span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select class="form-select" name="city">
                                    <option>City</option>
                                    @foreach ($city as $val)
                                        <option value="{{ $val->id }}" {{ $val->id == $company->city ? 'selected' : '' }}>
                                            {{ $val->cityname }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select" name="country">
                                    @foreach ($country as $val)
                                        <option value="{{ $val->id }}" {{ $val->id == $company->country ? 'selected' : '' }}>
                                            {{ $val->countryname }}
                                        </option>
                                    @endforeach
                                </select>
